...
import org.sid.ebankingbackend.exceptions.BalanceNoSufficientException;
...
*
    ...
    @Override
    public void transfer(String accountIdSource, double amount, String accountIdDestination) throws BalanceNoSufficientException, BankAccountNotFoundException {
